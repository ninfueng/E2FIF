...
parser.add_argument(
    "--dir_data",
    type=str,
    default="/data4/langzhiqiang/sr_data",
    help="dataset directory",
)
parser.add_argument(
    "--dir_demo", type=str, default="../test", help="demo image directory"
)
parser.add_argument(
...
parser.add_argument(
    "--data_range", type=str, default="1-800/801-900", help="train/test data range"
)
...
parser.add_argument(
    "--chop", action="store_true", help="enable memory-efficient forward"
)
parser.add_argument("--need_rgb", action="store_true", help="id need the rgb values")
parser.add_argument(
    "--need_mid_feas", action="store_true", help="id need the rgb values"
)
parser.add_argument(
...
parser.add_argument(
    "--n_convs", type=int, default=8, help="default number of filters. (Use in RDN)"
)
parser.add_argument(
...
parser.add_argument(
    "--decay", type=str, default="200-400-600-800", help="learning rate decay type"
)
parser.add_argument(
...
parser.add_argument(
    "--postfix", type=str, default="", help="postfix added to the model as save"
)
...
# Stereo images SR
parser.add_argument(
    "--tb_dir", type=str, default="", help="Tensorboard log file root path"
)
...
if "edsr" in args.model.lower():
    ...
    assert False
args.save += "_e{}_lr{}_b{}_p{}".format(
    args.epochs, args.lr, args.batch_size, args.patch_size
)
