        ...
        for nc in ncs:
            for scale in scales:
                args.model = "{}_{}".format(
                    model_name_prefix,
                    model_name
                    if model_name.find("org") > -1 or model_name.find("mrb") > -1
                    else "bireal" + model_name,
                )
